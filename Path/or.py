...
class ScalablePOIRouter:
    ...
    def create_intra_cluster_route(self, cluster: POICluster, 
                                 max_pois_per_cluster: int = 5) -> Tuple[List[str], float]:
        """
        Step 4: Create optimal route within a cluster using nearest neighbor.
        ...
        # Use nearest neighbor for intra-cluster routing
